...
public class JAXBUtil {
	...
	/* Esse código será executado assim que a classe for carregada, antes de qualquer método 
	 * estatico ser chamado e antes mesmo de qualquer variável estática poder ser usada. */
	static {
		try {
